# -*- coding: utf-8 -*-
"""
Created on Sat Jul 20 18:17:52 2019
...
data = loadtxt('expt.txt')
d = data[:, 0]
t = data[:, 1]-0.7
#Plot spectra
if (out_plt == "y" or out_plt == "yes"):
    fig, ax = plt.subplots()
    ax.locator_params(nbins=4)
    ax.plot(x_spec,FxG,'b')
    ax.plot(x_spec,y_spec,'r')
    plt.plot(d, t,'o', color='black')
    plt.xlim([13460,13485])
    plt.ylim([10230,10246])
